        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {certList.map((cert, idx) => (
            <div 
              ...
              className="bg-black/20 backdrop-blur-md border border-white/10 rounded-3xl p-8 hover:bg-black/30 transition-all duration-300 transform hover:-translate-y-1 flex flex-col justify-between"
            >
              <div>
                <div className="bg-white rounded-2xl p-4 w-16 h-16 flex items-center justify-center mb-6 shadow-md">
                  {cert.icon}
                </div>
